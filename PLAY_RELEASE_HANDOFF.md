...
- Latest paused implementation thread before this save: continue the broader iOS/Android parity audit after the main `+` new-shape button, map long-press new-shape flow, App Info screen, and Patch Notes screen were rechecked against current iOS source/String Catalog. Working tree was clean before this documentation update.
