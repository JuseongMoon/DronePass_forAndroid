...
> Latest code/parity checkpoint before this handoff update: settings map-display toggle/action contract pin
...
- Latest committed code/parity checkpoint before this documentation save: settings map-display toggle/action parity test update after settings language restart alert parity.
...
- Latest E2E preflight note: `:app:verifyCrossPlatformE2ePrerequisites` passed on 2026-07-06. This save additionally verified `:app:testDebugUnitTest --tests "*SettingsScreenContractTest" --tests "*StringResourceCoverageTest"`.
