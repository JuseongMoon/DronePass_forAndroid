...
class StringResourceCoverageTest {
    ...
    fun `shape detail labels match iOS localizations`() {
        assertEquals("드론", stringResourceValue("values/strings.xml", "shape_detail_drone_connected"))
        assertEquals("제목", stringResourceValue("values/strings.xml", "shape_detail_title_label"))
        assertEquals("좌표", stringResourceValue("values/strings.xml", "shape_detail_coordinate"))
        assertEquals("주소", stringResourceValue("values/strings.xml", "shape_detail_address"))
        assertEquals("반경", stringResourceValue("values/strings.xml", "shape_detail_radius"))
        ...
        assertEquals("시작일", stringResourceValue("values/strings.xml", "shape_detail_flight_start"))
        assertEquals("종료일", stringResourceValue("values/strings.xml", "shape_detail_flight_end"))
        assertEquals("메모", stringResourceValue("values/strings.xml", "common_memo"))
        ...
        assertEquals("카카오맵", stringResourceValue("values/strings.xml", "shape_detail_open_kakao_map"))
        ...
        assertEquals("더보기", stringResourceValue("values/strings.xml", "shape_detail_more_menu"))
        ...
        assertEquals("도형 삭제", stringResourceValue("values/strings.xml", "shape_detail_delete_title"))
        assertEquals("'%s' 도형을 삭제하시겠습니까?", androidDisplayStringResourceValue("values/strings.xml", "shape_detail_delete_message"))
        assertEquals("복사되었습니다", stringResourceValue("values/strings.xml", "shape_detail_copied"))
        assertEquals("Drone", stringResourceValue("values-en/strings.xml", "shape_detail_drone_connected"))
        assertEquals("Title", stringResourceValue("values-en/strings.xml", "shape_detail_title_label"))
        assertEquals("Coordinates", stringResourceValue("values-en/strings.xml", "shape_detail_coordinate"))
        assertEquals("Address", stringResourceValue("values-en/strings.xml", "shape_detail_address"))
        assertEquals("Radius", stringResourceValue("values-en/strings.xml", "shape_detail_radius"))
        assertEquals("Details", stringResourceValue("values-en/strings.xml", "shape_detail_navigation_title"))
        assertEquals("Altitude", stringResourceValue("values-en/strings.xml", "shape_detail_altitude"))
        assertEquals("Start Date", stringResourceValue("values-en/strings.xml", "shape_detail_flight_start"))
        assertEquals("End Date", stringResourceValue("values-en/strings.xml", "shape_detail_flight_end"))
        assertEquals("Memo", stringResourceValue("values-en/strings.xml", "common_memo"))
        assertEquals("Choose Navigation App", stringResourceValue("values-en/strings.xml", "shape_detail_open_external_map"))
        assertEquals("Naver Map", stringResourceValue("values-en/strings.xml", "shape_detail_open_naver_map"))
        assertEquals("Kakao Map", stringResourceValue("values-en/strings.xml", "shape_detail_open_kakao_map"))
        assertEquals("TMAP", stringResourceValue("values-en/strings.xml", "shape_detail_open_tmap"))
        assertEquals("Google Maps", stringResourceValue("values-en/strings.xml", "shape_detail_open_google_map"))
        assertEquals("Edit", stringResourceValue("values-en/strings.xml", "shape_detail_edit"))
        assertEquals("Duplicate", stringResourceValue("values-en/strings.xml", "shape_detail_duplicate"))
        assertEquals("More", stringResourceValue("values-en/strings.xml", "shape_detail_more_menu"))
        assertEquals("Deleted drone", stringResourceValue("values-en/strings.xml", "shape_detail_drone_deleted"))
        assertEquals("No drone assigned", stringResourceValue("values-en/strings.xml", "shape_detail_drone_unassigned"))
        assertEquals("Start navigation with the app below.", stringResourceValue("values-en/strings.xml", "shape_detail_navigation_message"))
        ...
        assertEquals("Copied", stringResourceValue("values-en/strings.xml", "shape_detail_copied"))
    }
    ...
    fun `shape edit labels match iOS localizations`() {
        ...
        assertEquals("검색 예시:", stringResourceValue("values/strings.xml", "search_address_example"))
        assertEquals("• 서초대로78길 24 (도로명)", stringResourceValue("values/strings.xml", "search_address_example_road_1"))
        assertEquals("• 서초동 1305-6 (지번)", stringResourceValue("values/strings.xml", "search_address_example_jibun_1"))
        assertEquals("• 테헤란로 322 (도로명)", stringResourceValue("values/strings.xml", "search_address_example_road_2"))
        assertEquals("• 역삼동 679-4 (지번)", stringResourceValue("values/strings.xml", "search_address_example_jibun_2"))
    ...
    fun `vworld zone detail strings match iOS localizations`() {
        ...
        assertEquals("구역 유형", stringResourceValue("values/strings.xml", "zone_detail_zone_type"))
        assertEquals("구역 코드", stringResourceValue("values/strings.xml", "zone_detail_code"))
        assertEquals("좌표", stringResourceValue("values/strings.xml", "zone_detail_coordinates"))
        assertEquals("고도 제한", stringResourceValue("values/strings.xml", "zone_detail_altitude_limit"))
        assertEquals("상한", stringResourceValue("values/strings.xml", "zone_detail_altitude_upper"))
        assertEquals("하한", stringResourceValue("values/strings.xml", "zone_detail_altitude_lower"))
        assertEquals("NOTAM 정보", stringResourceValue("values/strings.xml", "zone_detail_notam_title"))
        assertEquals("상태", stringResourceValue("values/strings.xml", "zone_detail_notam_status"))
        assertEquals("시작", stringResourceValue("values/strings.xml", "zone_detail_notam_start"))
        assertEquals("종료", stringResourceValue("values/strings.xml", "zone_detail_notam_end"))
        assertEquals("관리 기관", stringResourceValue("values/strings.xml", "zone_detail_authority_title"))
        assertEquals("기관명", stringResourceValue("values/strings.xml", "zone_detail_authority_name"))
        assertEquals("영문명", stringResourceValue("values/strings.xml", "zone_detail_authority_name_eng"))
        assertEquals("관리부서", stringResourceValue("values/strings.xml", "zone_detail_authority_department"))
        assertEquals("연락처", stringResourceValue("values/strings.xml", "zone_detail_authority_contact"))
        assertEquals("문화재 정보", stringResourceValue("values/strings.xml", "zone_detail_heritage_title"))
        assertEquals("문화재명", stringResourceValue("values/strings.xml", "zone_detail_heritage_name"))
        assertEquals("행정구역", stringResourceValue("values/strings.xml", "zone_detail_heritage_address"))
        assertEquals("용도지역", stringResourceValue("values/strings.xml", "zone_detail_heritage_zone"))
        assertEquals("고시", stringResourceValue("values/strings.xml", "zone_detail_heritage_designation"))
        assertEquals("%1\$s년 제%2\$s호", stringResourceValue("values/strings.xml", "zone_detail_heritage_designation_format"))
        assertEquals("남은 기간", stringResourceValue("values/strings.xml", "zone_detail_notam_remaining"))
        assertEquals("예정됨", stringResourceValue("values/strings.xml", "zone_detail_notam_status_scheduled"))
        ...
        assertEquals("알 수 없음", stringResourceValue("values/strings.xml", "zone_detail_notam_status_unknown"))
        ...
        assertEquals("Coordinates", stringResourceValue("values-en/strings.xml", "zone_detail_coordinates"))
        assertEquals("Altitude Limit", stringResourceValue("values-en/strings.xml", "zone_detail_altitude_limit"))
        assertEquals("Upper", stringResourceValue("values-en/strings.xml", "zone_detail_altitude_upper"))
        assertEquals("Lower", stringResourceValue("values-en/strings.xml", "zone_detail_altitude_lower"))
        assertEquals("NOTAM Information", stringResourceValue("values-en/strings.xml", "zone_detail_notam_title"))
        assertEquals("Status", stringResourceValue("values-en/strings.xml", "zone_detail_notam_status"))
        assertEquals("Start", stringResourceValue("values-en/strings.xml", "zone_detail_notam_start"))
        assertEquals("End", stringResourceValue("values-en/strings.xml", "zone_detail_notam_end"))
        ...
        assertEquals("Scheduled", stringResourceValue("values-en/strings.xml", "zone_detail_notam_status_scheduled"))
        assertEquals("Active", stringResourceValue("values-en/strings.xml", "zone_detail_notam_status_active"))
        assertEquals("Expired", stringResourceValue("values-en/strings.xml", "zone_detail_notam_status_expired"))
        assertEquals("Unknown", stringResourceValue("values-en/strings.xml", "zone_detail_notam_status_unknown"))
        ...
        assertEquals("English Name", stringResourceValue("values-en/strings.xml", "zone_detail_authority_name_eng"))
        assertEquals("Department", stringResourceValue("values-en/strings.xml", "zone_detail_authority_department"))
        assertEquals("Contact", stringResourceValue("values-en/strings.xml", "zone_detail_authority_contact"))
        assertEquals("Cultural Heritage Information", stringResourceValue("values-en/strings.xml", "zone_detail_heritage_title"))
        assertEquals("Heritage Name", stringResourceValue("values-en/strings.xml", "zone_detail_heritage_name"))
        assertEquals("Administrative District", stringResourceValue("values-en/strings.xml", "zone_detail_heritage_address"))
        assertEquals("Zoning", stringResourceValue("values-en/strings.xml", "zone_detail_heritage_zone"))
    ...
    @Test
    fun `vworld altitude unit strings match iOS localizations`() {
        assertEquals("지상 기준", stringResourceValue("values/strings.xml", "altitude_unit_agl"))
        assertEquals("평균 해수면 기준", stringResourceValue("values/strings.xml", "altitude_unit_amsl"))
        assertEquals("비행고도층 기준", stringResourceValue("values/strings.xml", "altitude_unit_fl"))
        assertEquals("고도 기준", stringResourceValue("values/strings.xml", "altitude_unit_ft_altitude"))
        assertEquals("높이 기준", stringResourceValue("values/strings.xml", "altitude_unit_ft_height"))
        assertEquals("평균 해수면 기준", stringResourceValue("values/strings.xml", "altitude_unit_msl"))
        assertEquals("지상", stringResourceValue("values/strings.xml", "altitude_value_ground"))
        assertEquals("표면", stringResourceValue("values/strings.xml", "altitude_value_surface"))
        assertEquals("제한없음", stringResourceValue("values/strings.xml", "altitude_value_unlimited"))

        assertEquals("above ground level", stringResourceValue("values-en/strings.xml", "altitude_unit_agl"))
        assertEquals("above mean sea level", stringResourceValue("values-en/strings.xml", "altitude_unit_amsl"))
        assertEquals("flight level", stringResourceValue("values-en/strings.xml", "altitude_unit_fl"))
        assertEquals("altitude", stringResourceValue("values-en/strings.xml", "altitude_unit_ft_altitude"))
        assertEquals("height", stringResourceValue("values-en/strings.xml", "altitude_unit_ft_height"))
        assertEquals("mean sea level", stringResourceValue("values-en/strings.xml", "altitude_unit_msl"))
        assertEquals("ground", stringResourceValue("values-en/strings.xml", "altitude_value_ground"))
        assertEquals("surface", stringResourceValue("values-en/strings.xml", "altitude_value_surface"))
        assertEquals("unlimited", stringResourceValue("values-en/strings.xml", "altitude_value_unlimited"))
    }
    ...
    fun `profile sync and account strings match iOS localizations`() {
        ...
        assertEquals("%d개", stringResourceValue("values/strings.xml", "profile_info_count_unit"))
        ...
        assertEquals("%d", stringResourceValue("values-en/strings.xml", "profile_info_count_unit"))
    ...
    fun `drone detail and edit strings match iOS localizations`() {
        ...
        assertEquals("드론 상세", stringResourceValue("values/strings.xml", "drone_detail_title"))
        assertEquals("드론 이름", stringResourceValue("values/strings.xml", "drone_detail_name"))
        assertEquals("색상", stringResourceValue("values/strings.xml", "drone_detail_color"))
        assertEquals("기본 정보", stringResourceValue("values/strings.xml", "drone_detail_section_basic"))
        assertEquals("사양", stringResourceValue("values/strings.xml", "drone_detail_section_specs"))
        assertEquals("미입력", stringResourceValue("values/strings.xml", "drone_detail_not_entered"))
        ...
        assertEquals("크기", stringResourceValue("values/strings.xml", "drone_detail_size"))
        assertEquals("메모", stringResourceValue("values/strings.xml", "drone_detail_section_memo"))
        assertEquals("편집", stringResourceValue("values/strings.xml", "common_edit"))
        assertEquals("삭제", stringResourceValue("values/strings.xml", "common_delete"))
        assertEquals("드론 삭제", stringResourceValue("values/strings.xml", "drone_detail_delete_title"))
        assertEquals(
            "정말로 '%s'을(를) 삭제하시겠습니까?",
            androidDisplayStringResourceValue("values/strings.xml", "drone_detail_delete_message"),
        )
        assertEquals("연결된 도형 처리", stringResourceValue("values/strings.xml", "drone_detail_shape_handling_title"))
        assertEquals(
        ...
        assertEquals("다른 드론으로 이동 (%d개)", stringResourceValue("values/strings.xml", "drone_detail_reassign"))
        assertEquals("도형도 함께 삭제 (%d개)", stringResourceValue("values/strings.xml", "drone_detail_delete_all_shapes"))

        assertEquals("드론 편집", stringResourceValue("values/strings.xml", "drone_edit_title_edit"))
        assertEquals("새 드론 추가", stringResourceValue("values/strings.xml", "drone_edit_title_create"))
        assertEquals("추가", stringResourceValue("values/strings.xml", "drone_edit_add"))
        assertEquals("드론 이름", stringResourceValue("values/strings.xml", "drone_edit_name_placeholder"))
        assertEquals("기본 정보", stringResourceValue("values/strings.xml", "drone_edit_section_basic"))
        assertEquals("한 줄을 넘어가지 않도록 입력해주세요", stringResourceValue("values/strings.xml", "drone_edit_section_basic_footer"))
        assertEquals("색상", stringResourceValue("values/strings.xml", "drone_edit_color"))
        ...
        assertEquals("예: 249g", stringResourceValue("values/strings.xml", "drone_edit_weight_placeholder"))
        assertEquals("예: 140×140×55mm", stringResourceValue("values/strings.xml", "drone_edit_size_placeholder"))
        assertEquals("사양", stringResourceValue("values/strings.xml", "drone_edit_section_specs"))
        assertEquals("드론의 이륙 무게와 크기를 입력하세요", stringResourceValue("values/strings.xml", "drone_edit_section_specs_footer"))
        assertEquals("메모", stringResourceValue("values/strings.xml", "drone_edit_section_memo"))
        assertEquals("드론에 대한 메모를 자유롭게 작성하세요", stringResourceValue("values/strings.xml", "drone_edit_section_memo_footer"))
        assertEquals("내 드론", stringResourceValue("values/strings.xml", "drone_edit_default_name_first"))
        assertEquals("드론 %d", stringResourceValue("values/strings.xml", "drone_edit_default_name"))
        assertEquals("저장 실패", stringResourceValue("values/strings.xml", "drone_edit_alert_save_failed"))
        assertEquals("드론 이름을 입력해주세요.", stringResourceValue("values/strings.xml", "drone_edit_alert_name_required"))
        assertEquals("이미 존재하는 드론 이름입니다.", stringResourceValue("values/strings.xml", "drone_edit_alert_name_duplicate"))

        assertEquals("Drone Details", stringResourceValue("values-en/strings.xml", "drone_detail_title"))
        assertEquals("Drone Name", stringResourceValue("values-en/strings.xml", "drone_detail_name"))
        assertEquals("Color", stringResourceValue("values-en/strings.xml", "drone_detail_color"))
        assertEquals("Basic Info", stringResourceValue("values-en/strings.xml", "drone_detail_section_basic"))
        assertEquals("Specifications", stringResourceValue("values-en/strings.xml", "drone_detail_section_specs"))
        ...
        assertEquals("Size", stringResourceValue("values-en/strings.xml", "drone_detail_size"))
        ...
        assertEquals("No memo", stringResourceValue("values-en/strings.xml", "drone_detail_memo_empty"))
        assertEquals("Edit", stringResourceValue("values-en/strings.xml", "common_edit"))
        assertEquals("Delete", stringResourceValue("values-en/strings.xml", "common_delete"))
        assertEquals("Delete Drone", stringResourceValue("values-en/strings.xml", "drone_detail_delete_title"))
        assertEquals(
            "Are you sure you want to delete '%s'?",
            androidDisplayStringResourceValue("values-en/strings.xml", "drone_detail_delete_message"),
        )
        assertEquals("Handle Connected Shapes", stringResourceValue("values-en/strings.xml", "drone_detail_shape_handling_title"))
        assertEquals(
        ...
        assertEquals("Move to another drone (%d)", stringResourceValue("values-en/strings.xml", "drone_detail_reassign"))
        assertEquals("Delete shapes too (%d)", stringResourceValue("values-en/strings.xml", "drone_detail_delete_all_shapes"))

        assertEquals("Edit Drone", stringResourceValue("values-en/strings.xml", "drone_edit_title_edit"))
        assertEquals("Add New Drone", stringResourceValue("values-en/strings.xml", "drone_edit_title_create"))
        assertEquals("Add", stringResourceValue("values-en/strings.xml", "drone_edit_add"))
        assertEquals("My Drone", stringResourceValue("values-en/strings.xml", "drone_edit_default_name_first"))
        assertEquals("Drone %d", stringResourceValue("values-en/strings.xml", "drone_edit_default_name"))
        assertEquals("Drone name", stringResourceValue("values-en/strings.xml", "drone_edit_name_placeholder"))
        assertEquals("Basic Information", stringResourceValue("values-en/strings.xml", "drone_edit_section_basic"))
        assertEquals("Please keep it within one line", stringResourceValue("values-en/strings.xml", "drone_edit_section_basic_footer"))
        assertEquals("Color", stringResourceValue("values-en/strings.xml", "drone_edit_color"))
        assertEquals("Enter serial number (optional)", stringResourceValue("values-en/strings.xml", "drone_edit_serial_placeholder"))
        assertEquals("Serial Number", stringResourceValue("values-en/strings.xml", "drone_edit_section_serial"))
        assertEquals(
            "Enter your drone's manufacturing or serial number",
            androidDisplayStringResourceValue("values-en/strings.xml", "drone_edit_section_serial_footer"),
        )
        assertEquals("e.g., 249g", stringResourceValue("values-en/strings.xml", "drone_edit_weight_placeholder"))
        assertEquals("e.g., 140×140×55mm", stringResourceValue("values-en/strings.xml", "drone_edit_size_placeholder"))
        assertEquals("Specifications", stringResourceValue("values-en/strings.xml", "drone_edit_section_specs"))
        assertEquals(
            "Enter drone's takeoff weight and size",
            androidDisplayStringResourceValue("values-en/strings.xml", "drone_edit_section_specs_footer"),
        )
        assertEquals("Memo", stringResourceValue("values-en/strings.xml", "drone_edit_section_memo"))
        assertEquals("Write notes about your drone freely", stringResourceValue("values-en/strings.xml", "drone_edit_section_memo_footer"))
        assertEquals("Save Failed", stringResourceValue("values-en/strings.xml", "drone_edit_alert_save_failed"))
        assertEquals("Please enter a drone name.", stringResourceValue("values-en/strings.xml", "drone_edit_alert_name_required"))
